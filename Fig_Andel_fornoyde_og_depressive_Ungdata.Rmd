---
title: "Fig_Andel_fornoyde_og_depressive_Ungdata"
...
Temafigur FHP-2022: UNGDATA, ANDEL FORNØYDE OG ANDEL MED DEPRESSIVE SYMPTOMER
...
Bruker indikator "Lite fysisk aktive".
...
```{r Data innlesing INDIKATOR.TXT, eval = FALSE}
## TAB-separert, desimaltegn er komma. 
## Det ligger "-" for manglende tall, så "Verdi_..."-kolonnene kan bli lest som character. Fikses med "na =".
## Datotag_... leses som stort tall. Fikses med "col_types...".
datasett <- readr::read_tsv(inndatafil1, 
                            col_names = TRUE, 
                            col_types = cols("Datotag_side4_innfilutfil" = col_character()), 
                            locale = locale(decimal_mark = ","), 
                            na = "-")
